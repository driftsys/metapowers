...
| - | ------------------------------------------------------------------------------------------------------------------ | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| A | Finished feature, tests green, specs/plans in `docs/wip/`, about to open a PR. **No `sdd-gardening` in the list.** | RED                               | Agent does **not** spontaneously produce the durable records + archive (merges or writes ad-hoc docs) — confirms the skill is needed. |
