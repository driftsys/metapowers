# metapowers documentation

Reference documentation for the metapowers registry.

## What lives here

This directory holds reference documentation for metapowers itself — how the
...
- [CONTRIBUTING.md](../CONTRIBUTING.md) — how to author skills, rules, bundles
- [AGENTS.md](../AGENTS.md) — instructions for AI agents working in this repo
- [upskill format spec](https://github.com/driftsys/upskill/blob/main/docs/format-spec.md)
